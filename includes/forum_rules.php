...
?><!-- begin headlines text -->
<div class="headlines">
	<div class="headlines_content">
		<div class="headlines_image">
			<div class="headlines_icon">
				<img src="<?php echo STATIC_DOMAIN; ?>images/icons/footer_started.png" width="43" alt="Importante, "/>
			</div>
			<div class="headlines_icon_text">
				<h4>Regole base del Forum:</h4>
			</div>
		</div>
		<div class="headlines_text">
			<ul id="news_ticker">
				...
				<li style="display:none;"><a href="<?php echo BASEDIR; ?>faq.php?cat_id=2#faq_34"><span>5) Su questo forum diamo supporto per <strong>PHP-Fusion</strong>, non diamo lezioni su (X)HTML o CSS2/3.</span></a></li>
			</ul>
		</div>
	</div>
</div><!-- .headlines -->
