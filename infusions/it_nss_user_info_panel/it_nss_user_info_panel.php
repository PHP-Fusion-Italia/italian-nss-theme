...
+--------------------------------------------------------+
| Filename: it_nss_user_info_panel.php
...
if (defined("IN_IT_NSS")) {
	if (!iMEMBER){
		if (!preg_match('/login.php/i',FUSION_SELF)) {
			...
			echo "<form id='it_nss_loginform' name='loginform' method='post' action='".$action_url."'>\n";
			echo "<label class='labelbox'>".$locale['global_101']."\n<input type='text' name='user_name' class='textbox' style='width:130px' /></label><br />\n";
			echo "<label class='labelbox'>".$locale['global_102']."\n<input type='password' name='user_pass' class='textbox' style='width:130px' /></label><br />\n";
			echo "<span class='labelbox'><label>".$locale['global_103']." <input type='checkbox' name='remember_me' value='y' title='".$locale['global_103']."' style='vertical-align:middle;' class='checkbox' /></label>\n";
			echo "<input type='submit' name='login' value='".$locale['global_104']."' class='button' /></span></form>\n";
			echo "<span class='divider_pad' style='padding-top: 5px; padding-bottom: 5px;'><!--[spacer]--></span>\n";
			echo "<span class='divider_hr'><!--[divider]--></span>\n";
		//	echo "<span class='divider_pad' style='padding-top: 5px; padding-bottom: 5px;'><!--[spacer]--></span>\n";
